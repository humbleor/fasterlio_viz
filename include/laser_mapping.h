...
// add
#include "treecylinder_fitter.hpp"
...
class LaserMapping {
   public:
    ...
    LaserMapping();
    LaserMapping(double accumulation_time, double max_distance);
    ...
    void PublishTrunk(const ros::Publisher &pub_trunk);
    void Savetrajectory(const std::string &traj_file);
    void Savetrunk(const std::string &trunk_file);

    void Finish();

    std::shared_ptr<TreeCylinderFitter> getTreeCylinderFitter() const { return cylinder_fitter_; }
   ...
   private:
    ...
    std::shared_ptr<TreeCylinderFitter> cylinder_fitter_ = nullptr;
